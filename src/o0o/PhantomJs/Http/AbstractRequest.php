...
use o0o\PhantomJs\Exception\InvalidMethodException;
use o0o\PhantomJs\Procedure\InputInterface;
    ...
    implements RequestInterface, InputInterface
{
     ...
     * @access public
     * @param  string                                             $method
     * @return \o0o\PhantomJs\Http\AbstractRequest
     * @throws \o0o\PhantomJs\Exception\InvalidMethodException
     */
    public function setMethod($method)
    {
        $method     = strtoupper($method);
        $reflection = new \ReflectionClass('\o0o\PhantomJs\Http\RequestInterface');
