...
use o0o\PhantomJs\Procedure\ProcedureLoaderFactory;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    public function testProcedureLoaderCanBeCreated()
    {
        ...
        $this->assertInstanceOf('\o0o\PhantomJs\Procedure\ProcedureLoaderInterface', $procedureLoader);
    }
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     * @return \o0o\PhantomJs\Procedure\ProcedureLoaderFactory
     */
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     *
     * @access protected
     * @return \o0o\PhantomJs\Procedure\ProcedureFactoryInterface
     */
    protected function getProcedureFactory()
    {
        $procedureFactory = $this->getMock('\o0o\PhantomJs\Procedure\ProcedureFactoryInterface');
