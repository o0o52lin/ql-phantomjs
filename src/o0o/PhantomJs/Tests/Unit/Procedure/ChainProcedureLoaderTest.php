...
use o0o\PhantomJs\Procedure\ChainProcedureLoader;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    public function testInstanceOfProcedureIsReturnedIfProcedureIsLoaded()
    {
        ...
        $this->assertInstanceOf('\o0o\PhantomJs\Procedure\ProcedureInterface', $chainProcedureLoader->load('test'));
    }
...
/** +++++++++++++++++++++++++++++++++++ **/
     ...
     * @return \o0o\PhantomJs\Procedure\ChainProcedureLoader
     */
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    {
        $procedure = $this->getMock('\o0o\PhantomJs\Procedure\ProcedureInterface');
