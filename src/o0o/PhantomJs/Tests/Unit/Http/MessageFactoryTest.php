 ...
 */
namespace o0o\PhantomJs\Tests\Unit\Http;

use o0o\PhantomJs\Http\MessageFactory;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    {
        $this->assertInstanceOf('\o0o\PhantomJs\Http\MessageFactory', MessageFactory::getInstance());
    }
    ...
    public function testCanCreateRequest()
    {
        ...
        $this->assertInstanceOf('\o0o\PhantomJs\Http\Request', $messageFactory->createRequest());
    }
    ...
    public function testCanCreateCaptureRequest()
    {
        ...
        $this->assertInstanceOf('\o0o\PhantomJs\Http\CaptureRequest', $messageFactory->createCaptureRequest());
    }
    ...
    public function testCanCreateResponse()
    {
        ...
        $this->assertInstanceOf('\o0o\PhantomJs\Http\Response', $messageFactory->createResponse());
    }
